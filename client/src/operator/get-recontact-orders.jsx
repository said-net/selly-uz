...
import { BiBox, BiCheckCircle, BiComment, BiCopy, BiGift, BiHistory, BiIdCard, BiInfoCircle, BiLoader, BiLocationPlus, BiMoney, BiPackage, BiQuestionMark, BiReceipt, BiRefresh, BiSave, BiSend, BiTrashAlt, BiUser, BiXCircle } from "react-icons/bi";
import Regions from '../assets/regions.json'
import { setLoad, setRefresh } from "../managers/config.manager";
function OperatorGetRecontactOrders() {
    ...
    useEffect(() => {
        setIsLoad(false);
        axios(`${API}/operator/get-recontact-orders`, {
            headers: {
    ...
    return (
        <div className="flex items-center justify-start flex-col w-full relative pb-[50px]">
            {/* INTRO */}
            <p className="uppercase text-white text-[20px] sm:text-[30px] animate-fade-down my-[10px]">Qayta aloqalar</p>
            {/* BODY */}
            <div className="flex items-start justify-center flex-wrap gap-2">
                ...
                {isLoad && orders[0] &&
                    orders?.map((o, i) => {
                        return (
                            <div className="flex items-start justify-start flex-col w-[90%] md:w-[300px] p-[5px] bg-white rounded h-[240px] relative hover:shadow-lg animate-fade-up" style={{ animationDelay: i + '00ms' }} key={o?.id}>
                                {/* ID - CREATED */}
                                ...
                                <p className="text-[14px] flex items-center justify-center gap-1">
                                    <BiComment />
                                    <span className="bg-indigo-500 text-white p-[2px] rounded">{o?.comment}</span>
                                    <Popover placement="top">
                                        <PopoverHandler>
                                            <IconButton className="w-[20px] text-[20px] text-gray-500 shadow-none h-[20px]" color="white">
                                                <BiInfoCircle />
                                        ...
                                        <PopoverContent className="p-[5px_10px]">
                                            <span className="text-blue-gray-900">Operator qoldirgan kommentariya</span>
                                        </PopoverContent>
                                    </Popover>
                                </p>
                                {/* UPTIME*/}
                                <p className="text-[14px] flex items-center justify-center gap-1">
                                    ...
                                    <Popover placement="top">
                                        ...
                                        <PopoverContent className="p-[5px_10px]">
                                            <span className="text-blue-gray-900">Oxirgi yangilanish vaqti</span>
                                        </PopoverContent>
                                    </Popover>
                                </p>
                                {/* VALUE */}
                                ...
                                {/* ACTIONS */}
                                <div className="flex items-center justify-end w-full gap-3 absolute bottom-[5px] right-[5px]">
...
export default OperatorGetRecontactOrders;