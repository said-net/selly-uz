...
// node_modules/use-scan-detection/dist/index.js
var require_dist = __commonJS({
  "node_modules/use-scan-detection/dist/index.js"(exports) {
    "use strict";
    ...
    var useScanDetection = function(_a) {
      ...
      var evaluateBuffer = function() {
        ...
        var sum = buffer.current.map(function(_a2, k, arr) {
          var time = _a2.time;
          return k > 0 ? time - arr[k - 1].time : 0;
        }).slice(1).reduce(function(total, delta) {
          return total + delta;
        }, 0);
        var avg = sum / (buffer.current.length - 1);
        var code = buffer.current.slice(startCharacter.length > 0 ? 1 : 0).map(function(_a2) {
          var char = _a2.char;
          return char;
        }).join("");
...
// dep:use-scan-detection
var use_scan_detection_default = require_dist();
export {
  use_scan_detection_default as default
};
//# sourceMappingURL=use-scan-detection.js.map
